...
const Window = function(tabs) {
    this.tabs = tabs;
    console.log(this) // We keep a record of the array inside the object
  };
  // When you join two windows into one window
  Window.prototype.join = function(otherWindow) {
    this.tabs = this.tabs.concat(otherWindow.tabs);
    console.log(otherWindow.tabs)
  ...
  Window.prototype.tabOpen = function(tab) {
    ...
    console.log(this.tabs)// Let's open a new tab for now
    return this;
  };
...
var ratings = watchList.map(({Title,imdbRating})=>({"title":Title,"rating":imdbRating}));
